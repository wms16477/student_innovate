...
public interface InnoProjectMapper extends BaseMapper<InnoProject> {
    ...
    List<InnoProject> getTableList(@Param("dto") InnoProjectDTO dto, @Param("userId") Long userId, @Param("userCode") String userCode, @Param("userType") Integer userType, @Param("projectType") String projectType);
